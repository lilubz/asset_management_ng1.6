...
gulp.task('build', ['image', 'js', 'less', 'html', 'libjs', 'libcss', 'static']);
...
gulp.task('serve', ['build'], function() {
  ...
  gulp.watch('bower_components/**/*.js', ['libjs']);
  gulp.watch('bower_components/**/*.css', ['libcss']);
  gulp.watch(app.srcPath + '**/*.html', ['html']);
  gulp.watch(app.srcPath + '**/*.less', ['less']);
  gulp.watch(app.srcPath + '**/*.js', ['js']);
  gulp.watch(app.srcPath + 'image/**/*', ['image']);
  gulp.watch(app.srcPath + 'static/**/*', ['static']);
});
